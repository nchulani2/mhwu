import {
  ...
  } from './MonsterImagesExports';
  
  // import {Water, Thunder, Ice, Dragon, Fire} from './ElementalExports'

  import { Blastblight, Bleeding, DragonBlight, EffluvialBuildup, Fireblight, Iceblight, Paralysis, Poison, Sleep, Stun, Thunderblight, Waterblight, WindPressure, DefenseDown, Muddy} from './BlightExports'
...
// NOTE UNABLE TO USE DUE TO RETARD API DEV NOT USING KEY VALUE PAIRS
